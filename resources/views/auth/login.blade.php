        ...
        <div class="container-fluid d-flex flex-column justify-content-between" style="min-height: 100vh;">
            <div class="d-flex flex-column gap-2 pt-2">
                <div class="col d-flex flex-column justify-content-between" style="margin:48px">
                    <h4 class="text-center" style="font-weight: 700; font-size: 32px;width: 100%">{{ __('auth.login') }}</h4>
                    ...
                    <span class="text-center mt-2">
                        {{ __('auth.detail') }}<a href="{{route('register')}}" style="text-decoration: none;"> Register</a>
                    </span>
                </div>
            </div>
        </div>

    ...
    <div class="d-flex flex-column gap-2">
        ...
        <div class="d-flex flex-column justify-content-center align-items-center m-4 p-2 gap-2">
            <div class=" bg-white p-4" style="width: 320px;">
                ...
                <h6>M-Trasnfer</h6>
                <h6>{{$transaksi->nomer_transaksi}}</h6>
                <h6>{{$detail['jenis_transaksi']}}</h6>
                <h6>Total {{$transaksi->total}}</h6>
                <h6>Dari {{$user->telp}}</h6>
            </div>
        </div>
        ...
        <div class="d-flex flex-row gap-3 justify-content-center align-items-center p-4">
            ...
            <a href="{{ route('transfer-pin', $transaksi->id) }}" class="p-2 text-center" style="background: blue; color: #ffffff; font-weight: 500; text-decoration: none; width: 100%;">Ok</a>
        </div>

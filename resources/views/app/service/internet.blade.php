...
<div class="container-fluid d-flex flex-column justify-content-between" style="min-height: 100vh;">
    <div class="d-flex flex-column gap-2 pt-2">
        <div class="col d-flex flex-row justify-content-between gap-4">
            ...
            <h4 class="text-center" style="background: white; border-radius:16px; padding: 4px; width: 100%">{{ __('internet.internet') }}</h4>
        ...
        <div class="d-flex flex-column justify-content-between m-4 p-4">
            <form method="POST" action="{{ route('buat-transaksi') }}">
                @csrf
                <div class="d-flex flex-column gap-1">
                    <label for="layanan" class="block text-sm font-medium text-gray-600">{{ __('internet.service') }}</label>
                ...
                <div class="d-flex flex-column gap-1">
                    <label for="pelanggan" class="block text-sm font-medium text-gray-600">{{ __('internet.pelanggan') }}</label>
                ...
                <button type="submit" style="width: 100%;" class="mt-4">{{ __('internet.check') }}</button>
            </form>
        </div>
